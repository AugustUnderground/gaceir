...
def run_episode(*_coconut_match_args, **_coconut_match_kwargs):  #185 (line num in coconut source)
    ...
    if (6 <= _coconut.len(_coconut_match_args) <= 8) and ("episode" not in _coconut_match_kwargs) and (_coconut.sum((_coconut.len(_coconut_match_args) > 6, "loss" in _coconut_match_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 7, "reward" in _coconut_match_kwargs)) == 1) and (_coconut_match_args[5] is True):  #185 (line num in coconut source)
        _coconut_match_temp_3 = _coconut_match_args[2] if _coconut.len(_coconut_match_args) > 2 else _coconut_match_kwargs.pop("episode")  #185 (line num in coconut source)
        _coconut_match_temp_4 = _coconut_match_args[6] if _coconut.len(_coconut_match_args) > 6 else _coconut_match_kwargs.pop("loss")  #185 (line num in coconut source)
        _coconut_match_temp_5 = _coconut_match_args[7] if _coconut.len(_coconut_match_args) > 7 else _coconut_match_kwargs.pop("reward")  #185 (line num in coconut source)
        if not _coconut_match_kwargs:  #185 (line num in coconut source)
            _coconut_match_set_name_episode = _coconut_match_temp_3  #185 (line num in coconut source)
            _coconut_match_set_name_loss = _coconut_match_temp_4  #185 (line num in coconut source)
            _coconut_match_set_name_reward = _coconut_match_temp_5  #185 (line num in coconut source)
    ...
    if _coconut_match_check_1:  #185 (line num in coconut source)
        if _coconut_match_set_name_episode is not _coconut_sentinel:  #185 (line num in coconut source)
            episode = _coconut_match_temp_3  #185 (line num in coconut source)
        if _coconut_match_set_name_loss is not _coconut_sentinel:  #185 (line num in coconut source)
            loss = _coconut_match_temp_4  #185 (line num in coconut source)
        if _coconut_match_set_name_reward is not _coconut_sentinel:  #185 (line num in coconut source)
            reward = _coconut_match_temp_5  #185 (line num in coconut source)
    if not _coconut_match_check_1:  #185 (line num in coconut source)
        raise _coconut_FunctionMatchError('def run_episode(_, _, episode, _, _, True, loss, reward) = model where:', _coconut_match_args)  #185 (line num in coconut source)
...
def run_episode(*_coconut_match_args, **_coconut_match_kwargs):  #191 (line num in coconut source)
    ...
    if (6 <= _coconut.len(_coconut_match_args) <= 8) and ("envs" not in _coconut_match_kwargs) and ("model" not in _coconut_match_kwargs) and ("episode" not in _coconut_match_kwargs) and ("iteration" not in _coconut_match_kwargs) and ("states" not in _coconut_match_kwargs) and (_coconut.sum((_coconut.len(_coconut_match_args) > 6, "loss" in _coconut_match_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 7, "reward" in _coconut_match_kwargs)) == 1):  #191 (line num in coconut source)
        _coconut_match_temp_6 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("envs")  #191 (line num in coconut source)
        _coconut_match_temp_7 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("model")  #191 (line num in coconut source)
        _coconut_match_temp_8 = _coconut_match_args[2] if _coconut.len(_coconut_match_args) > 2 else _coconut_match_kwargs.pop("episode")  #191 (line num in coconut source)
        _coconut_match_temp_9 = _coconut_match_args[3] if _coconut.len(_coconut_match_args) > 3 else _coconut_match_kwargs.pop("iteration")  #191 (line num in coconut source)
        _coconut_match_temp_10 = _coconut_match_args[4] if _coconut.len(_coconut_match_args) > 4 else _coconut_match_kwargs.pop("states")  #191 (line num in coconut source)
        _coconut_match_temp_11 = _coconut_match_args[6] if _coconut.len(_coconut_match_args) > 6 else _coconut_match_kwargs.pop("loss")  #191 (line num in coconut source)
        _coconut_match_temp_12 = _coconut_match_args[7] if _coconut.len(_coconut_match_args) > 7 else _coconut_match_kwargs.pop("reward")  #191 (line num in coconut source)
        if not _coconut_match_kwargs:  #191 (line num in coconut source)
            _coconut_match_set_name_envs = _coconut_match_temp_6  #191 (line num in coconut source)
            _coconut_match_set_name_model = _coconut_match_temp_7  #191 (line num in coconut source)
            _coconut_match_set_name_episode = _coconut_match_temp_8  #191 (line num in coconut source)
            _coconut_match_set_name_iteration = _coconut_match_temp_9  #191 (line num in coconut source)
            _coconut_match_set_name_states = _coconut_match_temp_10  #191 (line num in coconut source)
            _coconut_match_set_name_loss = _coconut_match_temp_11  #191 (line num in coconut source)
            _coconut_match_set_name_reward = _coconut_match_temp_12  #191 (line num in coconut source)
